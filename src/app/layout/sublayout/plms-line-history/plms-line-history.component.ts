...
import {
  Line_BurnerLockout, Line_Menu, Line_PreRoller,
  Line_BeadingMotor, Line_BrushMotor, Line_RinseBlower
} from '../models/line';
...
export class PlmsLineHistoryComponent implements OnInit {
  ...
  setActiveParam(paramName): any {
    this.SelectedParam = paramName;
    console.log('this is param ' + this.SelectedParam);
  }
