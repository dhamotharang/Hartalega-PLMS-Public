...
export const user_service_update  :string  ='PlmsLogin/UpdateData'
...
export const chart_service_GetLineChartBottom:string='Chart/GetChart_LowChampAmpBottom/';

export const chart_service_LowChampAmpTopMaxMin:string='Chart/GetMaxMin_LowChampAmpTop/'
export const chart_service_LowChampAmpBottomMaxMin:string='Chart/GetMaxMin_LowChampAmpBottom/'
